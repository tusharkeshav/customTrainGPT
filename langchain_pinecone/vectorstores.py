...
class PineconeVectorStore(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        if index:
            ...
            # self._index = client.Index(_index_name, host="https://first-book-index-yipil0n.svc.gcp-starter.pinecone.io")
            self._index = client.Index(_index_name, host=index_host) if index_host is not None else client.Index(_index_name)
    ...
    def from_existing_index(
        ...
        pinecone_index = cls.get_pinecone_index(index_name, pool_threads)
        return cls(pinecone_index, embedding, text_key, namespace, index_host)
